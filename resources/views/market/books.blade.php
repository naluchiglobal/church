...
<head>
        ...
        <title>Books | {{$site->site_name}}</title>
                        ...
                        <div class="content">
                            <div class="list_products shop_mode_thumbs">
                                <p class="woocommerce-result-count">
                                    <a class="button wc-forward " href="{{route('books')}}">BOOKS</a>
                                    <a class="button checkout wc-forward" href="{{route('series')}}" {{ Request::is('series') ? 'current-menu-item' : '' }}>SERIES</a>
                                    <a class="button checkout wc-forward" href="{{route('gifts')}}">GIFTS</a>
                                </p>
                                <!-- Products list -->
                                <ul class="products">
                                    ...
                                    <div class="widget_shopping_cart_content">
                                        <ul class="cart_list product_list_widget">
                                            <li class="mini_cart_item" >
                                                <a class="remove" href="{{ route('store.show', [ 'slug' => $post->slug]) }}" title="Remove this item">×</a>
                                            ...
                                            <li class="mini_cart_item">
                                                <a class="remove" href="{{ route('store.show', [ 'slug' => $post->slug]) }}" title="Remove this item">×</a>
                                                <a href="{{ route('store.show', [ 'slug' => $post->slug]) }}l">
