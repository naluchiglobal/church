...
<div class="top_panel_title top_panel_style_3 title_present breadcrumbs_present scheme_original">
    <div class="top_panel_title_inner top_panel_inner_style_3 breadcrumbs_block_bg1">
        <div class="content_wrap">
            <h1 class="page_title">Welcome to our Home cell Group</h1>
        </div>
    </div>
</div>
<div class="sc_line sc_line_position_center_center sc_line_style_solid" style="visibility: hidden"></div>
<p  class="sc_title sc_title_regular sc_align_center">Homecell is a vital part jubilee Christian hurch int'l. This is because it is the best way you can connect  to others with the passion in the church.<br>
    Each homecell group is a healthy community of people, expressing what they believe, exploitingt their faith together and developing friendship.
    <br>Most of the Homecell group meet at least once a month. If you want to plug into any of the life group, register below.<br>
</p>
            ...
            <article class="post_item post_item_single page">
                <section class="post_content">
                    <div class="woocommerce">
                        <form method="post" action="{{route('homecell.post')}}" class="checkout woocommerce-checkout">
                            {{csrf_field()}}
